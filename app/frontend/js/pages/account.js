...
(function (S) {
  S.pages.account = {
    title: 'Account',
    html: function () {
      var email = S.auth.email() || 'Not signed in';
      var initials = S.auth.email() ? S.initials(email.split('@')[0].replace(/[._-]+/g, ' ')) : '?';
      ...
      return '<div class="account">' +
        ...
        '<div class="profile-disc">' + initials + '</div>' +
        '<div class="profile-main"><div class="profile-name">' + email + '</div><div class="profile-email">Signed in with Google</div></div>' +
